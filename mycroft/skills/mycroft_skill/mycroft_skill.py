...
class MycroftSkill:
    ...
    def disable_intent(self, intent_name):
        ...
        """
        if intent_name in [i[0] for i in self.intent_service]:
    ...
    def enable_intent(self, intent_name):
        ...
        """
        names = [intent[0] for intent in self.intent_service]
        intents = [intent[1] for intent in self.intent_service]
    ...
    def schedule_repeating_event(self, handler, when, frequency,
        ...
        """
        self.event_scheduler.schedule_repeating_event(handler, when,
                                                      frequency, data, name)
    ...
    def get_scheduled_event_status(self, name):
        ...
        """
        self.event_scheduler.get_scheduled_event_status(name)
