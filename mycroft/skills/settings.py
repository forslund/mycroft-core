...
class SkillSettings(dict):
    ...
    def _upload_meta(self, settings_meta, identifier):
        ...
        """
        LOG.info('Uploading settings meta for {}'.format(identifier))
    ...
    def update_remote(self):
        ...
        if skills_settings is not None:
            ...
            LOG.info("NO Settings on server for {}".format(self.skill_gid))
        ...
        if settings:
            ...
            for skill_settings in settings:
                if skill_settings['identifier'] == identifier:
                    LOG.info("Fetched settings for {}".format(identifier))
                    skill_settings = \
